...
type AnswerBlock =
  ...
  | { type: "paragraph2"; content: string }
...
const faqData: FaqItem[] = [
  ...
  },
  {
    ...
    answer: [
      ...
      {
        type: "title",
        content: "Переосмысление здоровья и баланса",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "title",
        content: "Всплеск интереса к IT и новым навыкам",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "title",
        content: "Новые перспективы в сфере труда",
      },
      {
        type: "paragraph",
        content:
      ...
      {
        type: "title",
        content: "Важность оптимизма и обучения",
      },
      {
        type: "paragraph",
        content:
              ...
              {isOpen && (
                ...
                >
                  {item.answer.map((block, i) => {
                    ...
                    if (block.type === "title") {
                      return (
                        <li key={i} className={styles.answerTitle}>
                          {block.content}
                        </li>
                      );
                    }
                    if (block.type === "paragraph2") {
                      return (
